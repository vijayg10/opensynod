...
const members = [
  ...
  },
  {
    ...
    desc: "And I love you like Kanye loves Kanye. We need to restart that creativity.",
  },
  {
    ...
    <section className="py-8 px-8 lg:py-16">
      <div className="container mx-auto">
        <div className="mb-24 text-center">
          <Typography color={"dark" as any} className="mb-2 !font-semibold text-lg">
            Our Team
          </Typography>
          ...
          >
            ...
            team. Keep your users engaged by providing meaningful information.
          </Typography>
        </div>
